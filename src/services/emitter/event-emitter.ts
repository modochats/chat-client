...
export class EventEmitter {
  ...
  getEventTypes(): EventType[] {
    ...
    Object.keys(this.listeners).forEach(key => types.add(key as unknown as EventType));
    Object.keys(this.onceListeners).forEach(key => types.add(key as unknown as EventType));
